...
The people and places your network belongs to - where things are located and
...
!!! note "Tenants & sites"
    ...
    their own right - see the **Data models** section for [Tenant](../models/tenant.md)
    and [Site](../models/site.md).
