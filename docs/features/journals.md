...
You can edit or delete **your own** notes; an administrator can edit or delete
any. The edit and delete controls only show on notes you're allowed to change.

!!! tip "Author is preserved"
    A note keeps the author's name even if that user account is later removed, so
