...
Keep an eye on whether things are **up** and whether they're **configured the
way they should be**.
...
Background workers and the scheduler live under
[Background jobs](../features/jobs.md) (Working with data).
