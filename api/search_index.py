...
SPECS: dict[str, IndexSpec] = {
    ...
    "natrule": IndexSpec("api.NATRule", "/nat-rules/{id}", weight=6,
                         site="device.site", subtitle="device.name",
                         body=("external_ports", "internal_ports",
    ...
    "vtep": IndexSpec("routing.VTEP", "/devices/{device_id}?tab=routing", weight=5,
                      site="device.site", subtitle="device.name",
                      body=("source_ip.ip_address", "anycast_ip.ip_address", "description")),
    "ldpinstance": IndexSpec("routing.LDPInstance", "/devices/{device_id}?tab=routing",
                             weight=5, site="device.site", subtitle="device.name",
                             body=("router_id", "transport_address", "description")),
    "ethernetsegment": IndexSpec("routing.EthernetSegment", "/ethernet-segments/{id}",
                                 weight=5, site=None,
                                 body=("esi", "sys_mac", "description")),
    ...
    "prefixlist": IndexSpec("routing.PrefixList", "/prefix-lists/{id}", weight=5,
                            site=None, subtitle="description"),
    "communitylist": IndexSpec("routing.CommunityList", "/community-lists/{id}",
                               weight=5, site=None, subtitle="description"),
    "aspathlist": IndexSpec("routing.ASPathList", "/as-path-lists/{id}", weight=5,
                            site=None, subtitle="description"),
    "community": IndexSpec("routing.Community", "/communities/{id}", weight=5,
