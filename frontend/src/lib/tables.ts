...
export const TABLES: TableMeta[] = [
  ...
  { id: "bgp-instances", label: "BGP instances", area: "Routing", ioType: "bgpinstance" },
  { id: "ospf-instances", label: "OSPF instances", area: "Routing", ioType: "ospfinstance" },
  { id: "isis-instances", label: "IS-IS instances", area: "Routing", ioType: "isisinstance" },
  { id: "vteps", label: "VTEPs", area: "Routing", ioType: "vtep" },
  { id: "embedded-bgp-sessions", label: "BGP sessions (embedded)", area: "Routing" },
  { id: "embedded-static-routes", label: "Static routes (embedded)", area: "Routing" },
