...
export const DOCS_LINKS: Record<string, string> = {
  ...
  "/virtual-topology": "features/external-sync/",
  ...
  "/dhcp-scopes": "features/external-sync/",
  "/dhcp-reservations": "features/external-sync/",
  "/dhcp-leases": "features/external-sync/",
  "/dns-zones": "features/external-sync/",
  "/dns-records": "features/external-sync/",
