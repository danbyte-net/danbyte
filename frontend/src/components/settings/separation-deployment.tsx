...
/** The deployment half of separation: the default every tenant inherits
 * until it overrides. Rendered by the Separation page under its Deployment
 * scope (#51). */
export function SeparationDeploymentCards() {
  return (
    <SettingsGrid>
      <SeparationCard />
      <DelegationCard />
...
function SeparationCard() {
  ...
  return (
    <SettingsCard
      ...
      description="The default every tenant inherits until it overrides."
      onSave={() =>
        save.mutate({
          key: "separation",
          patch: {
